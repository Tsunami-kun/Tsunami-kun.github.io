...
\hypersetup{
  ...
  linkcolor=blue,      % (if you also want internal links blue)
  citecolor=blue       % (if you want citations blue)
}
...
\definecolor{linecolor}{RGB}{128,0,0}
% Defines the rSection environment for the large sections within the CV

\usepackage{xspace}
\newcommand{\synpoldex}{\textbf{\textsc{SynPolDex}}\xspace}
\newcommand{\bimangrasp}{\textbf{\textsc{BimanGrasp}}\xspace}
...
\begin{onecolentry}
    ...
    \item Developing Human-Like Dexterous Manipulation Skills for Humanoid Robots, especially those beyond two-fingered grippers, like in-hand rotation and grasping multiple objects in one hand.
    \end{highlightsforbulletentries}
\end{onecolentry}

\textbf{Scalable Robotic Models}
\begin{onecolentry}
    \begin{highlightsforbulletentries}
    \item Exploring scaling law of robotic models, especially  video generation models and large multimodal (forceful, tactile) models that could serve as "brain" of robots.
    \end{highlightsforbulletentries}
\end{onecolentry}
...
\begin{enumerate}[label={[\arabic*]}]
  ...
  \item \textbf{Yanming Shao}, Yan Ding*, and Chenxi Xiao*, 
        ...
        \emph{Accepted by Humanoids 2025}.
\end{enumerate}
...
\section{RESEARCH EXPERIENCES}
    ...
    \textit{Sep 2023 – Present}}
        ...
        \textit{Robot Interaction and Manipulation (RIM) Lab}
    \end{twocolentry}
    ...
    \textit{Nov 2024 – March 2025}}
        ...
        \textit{Shanghai AI Laboratory}

        \textit{Intelligent Photonics and Electronics Center (IPEC)}
    \end{twocolentry}
...
\begin{itemize}
    \item Teaching Assistant, Embodied Intelligence (ShanghaiTech University, 2025 Spring)
    \item Teaching Assistant, Introduction to Information Science (ShanghaiTech University, 2024 Fall)
\end{itemize}
...
\textit{ }}
\textbf{\textsc{BimanGrasp}}\xspace
    
    \textit{The project conducted at ShanghaiTech RIM Lab. We proposed the BimanGrasp algorithm (based on stochastic optimization) and generated the first large-scale bimanual dexterous grasping dataset over 900 daily objects.}
...
\begin{figure*}[htpb]
    ...
    \caption{BimanGrasp enables a pair of dexterous hands to grasp various objects, including large and heavy ones, far beyond 
 the capability of unimanual grasping.}
\end{figure*}

\begin{figure*}[htpb]
    \centering
    \includegraphics[width=.8\linewidth]{img/bimangrasp_poster.png}
    \caption{BimanGrasp leveraged differentiable force closure computing to obtain dexterous grasp poses, those poses are valided in Isaac Gym, and construct a large-scale grasp pose dataset called BimanGrasp-Dataset. }
\end{figure*}
...
\textit{ }}
\textbf{\textsc{SynPolDex}}\xspace
    
    \textit{The project conducted at ShanghaiTech RIM Lab and Shanghai AI Lab IPEC center. We propose the concept and framework of Synergetic Dexterity, which enables human-like finger-level coordination of multi-fingered hands.}
...
\textit{ }}
\textbf{\textsc{CleverGrasp}}\xspace
    
    \textit{The project was conducted in ShanghaiTech RIM Lab, which leverated both differentiable force closure and finger-level planning for dexterous grasping. It first initialize a pose based on finger planning, then optimize to reach a stable pose with such finger prior.}
...
\begin{onecolentry}
Recent demo snapshots from dexterous teleoperation and simulation. Video: \hrefWithoutArrow{https://tsunami-kun.github.io/demo/demo.mp4}{online demo}
\end{onecolentry}
...
\begin{figure*}[ht]
    ...
    \begin{minipage}[t]{0.6\linewidth}
        \centering
        \includegraphics[width=\linewidth]{demo_image/sim.jpg}
    \end{minipage}
    \hfill
    ...
    \end{minipage}
    \caption{Left: a dexterous manipulation simulation snapshot used for policy debugging and evaluation. Right: the Noitom glove setup used for teleoperation and data collection.}
...
\textbf{\textsc{Obstructions in Geometric Complexity Theory}}\xspace
