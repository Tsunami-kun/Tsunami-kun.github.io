...
\section{RESEARCH EXPERIENCES}
    ...
    \begin{onecolentry}
        \begin{highlightsforbulletentries}
            \item Leading projects on bimanual grasp synthesis, finger-level policy learning, and synthetic human priors for dexterous manipulation.
            \item Developed \BimanGrasp, \SynPolDex, and the ongoing \SynManDexName{} pipeline for human-like dexterous grasping and manipulation data generation.
        \end{highlightsforbulletentries}
    \end{onecolentry}
    ...
    \begin{onecolentry}
        \begin{highlightsforbulletentries}
            \item Worked on dexterous manipulation and data-centric embodied AI, spanning policy learning, post-training, multimodal robot data generation, and DexHiL-related collaborations.
        \end{highlightsforbulletentries}
    \end{onecolentry}
...
\vspace{0.12 cm}
{\small \textbf{\SynManDexName{} at a glance.} Human priors provide natural pre-grasps, physics-based refinement makes them valid for robot hands, and the resulting trajectories support contact-rich bimanual policy learning.}
...
\begin{minipage}[t]{0.54\linewidth}
    ...
    \vspace{0.12 cm}
    {\small Three-stage pipeline: pre-grasp diffusion, robot-hand refinement, and geometry-consistent trajectory generation.}
\end{minipage}
\hfill
\begin{minipage}[t]{0.42\linewidth}
    ...
    \vspace{0.12 cm}
    {\small Qualitative trajectories preserve human-like contact semantics while remaining executable on a 36-DoF bimanual platform.}
\end{minipage}
\end{onecolentry}
