...
\section{RESEARCH EXPERIENCES}
    ...
    \textit{Sep 2023 – Present}}
        ...
        \textit{Robot Interaction and Manipulation (RIM) Lab, ShanghaiTech University (with Chenxi Xiao)}
    \end{twocolentry}
    ...
    \textit{Nov 2024 – March 2025}}
        ...
        \textit{Intelligent Photonics and Electronics Center (IPEC), Shanghai AI Laboratory (with Yan Ding)}
    \end{twocolentry}
    ...
    \textit{June 2025 – Oct 2025}}
        \textbf{Research Intern}
        \textit{Shanghai Qizhi Institute (with Macheng Shen)}
    \end{twocolentry}
    ...
    \textit{Oct 2025 – Present}}
        \textbf{Research Intern}
        \textit{Intern Robotics, Shanghai AI Laboratory (with Yao Mark Mu)}
    \end{twocolentry}
